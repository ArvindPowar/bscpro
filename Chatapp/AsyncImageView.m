...
#define SPINNY_TAG 5555   
    ...
    spinny.center = CGPointMake(self.imageView.frame.size.width+60 /2, imageView.frame.size.height+60/2);
    [spinny setColor:[UIColor blackColor]];
    //[spinny.layer setBackgroundColor:[[UIColor blackColor] CGColor]];
    spinny.tag = SPINNY_TAG;
    //spinny.center = self.imageView.center;
