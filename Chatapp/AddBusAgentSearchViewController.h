//
//  AddBusAgentSearchViewController.h
//  Chatapp
//
...
@interface AddBusAgentSearchViewController : UIViewController<UITableViewDataSource,UITableViewDelegate,UISearchDisplayDelegate,UISearchBarDelegate>{
    BOOL isSearching;
