...
@synthesize appDelegate,feedData,userData,searchString,postupload;
...
- (void)viewDidLoad
{
    ...
    mainFeeds.feedData=feedData;
    mainFeeds.appDelegate.userData=userData;
    
    mainFeeds.postupload=[[NSString alloc] init];
    mainFeeds.postupload=postupload;
    
    UINavigationController *frontNavigationController = [[UINavigationController alloc] initWithRootViewController:mainFeeds];
